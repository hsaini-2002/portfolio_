  ...
  return (
    <section className="relative bg-[#C29776] text-white px-6 md:px-12 pt-10 pb-20 rounded-t-[2rem] overflow-hidden">
      <div className="max-w-[1512px]  relative z-10 ">
        ...
        <div className="absolute left-1/2 top-[41%] md:top-[35%] transform -translate-x-1/2 -translate-y-37 z-2">
          <div className=" ">
            <Image
              src="/moniter.png"
              alt="Monitor"
        ...
        <div className="mt-60 md:mt-40 flex flex-wrap mx-10 sm:justify-center md:justify-between items-center text-black text-lg font-light px-2 md:px-0">
